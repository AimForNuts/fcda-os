...
describe('TeamAssignmentToggle', () => {
  it('renders white, blue, and no-team options with accessible labels', () => {
    ...
    expect(screen.getByRole('button', { name: 'Equipa Azul' })).toBeInTheDocument()
  ...
  it('calls onChange with the selected option', () => {
    ...
    fireEvent.click(screen.getByRole('button', { name: 'Equipa Azul' }))
